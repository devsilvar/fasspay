export const explanationData = [
  ...
  },
  {
    ...
    description:
      "Customer Pays: Your customer generates a secure PayCode on Faaspay in seconds to pay you instantly. Funds Secured: Faaspay handles all payments securely using encrypted PayCodes. Fast Settlements: Receive your funds in your local African currency in seconds with no processing fees",
  },
];
